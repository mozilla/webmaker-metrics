...
function productRetention90Day (callback) {
  'use strict';
  var args = {metricName: 'AU90dayRetention', days: 7, x100: true};
  getProductSnapshotValue(args, function (err, result) {
    if (err) {
      console.error(err);
      return callback(err);
...
function emailOptinRate1day (callback) {
  'use strict';
  var args = {metricName: 'NewUserOptinRate1day', days: 7, x100: true};
...
function emailOptins1day (callback) {
  'use strict';
  var args = {metricName: 'NewUserOptins1day', days: 7, x100: false};
  getEmailOptinSnapshotValue(args, function (err, result) {
    if (err) {
      console.error(err);
      return callback(err);
...
function emailOptinRate7days (callback) {
  'use strict';
  var args = {metricName: 'NewUserOptinRate7days', days: 7, x100: true};
  getEmailOptinSnapshotValue(args, function (err, result) {
    if (err) {
      console.error(err);
      return callback(err);
...
function emailOptinRate30days (callback) {
  'use strict';
  var args = {metricName: 'NewUserOptinRate30days', days: 7, x100: true};
  getEmailOptinSnapshotValue(args, function (err, result) {
    if (err) {
      console.error(err);
      return callback(err);
