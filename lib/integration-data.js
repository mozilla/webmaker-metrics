...
function queryBadgesNew (args, badgeNames, callback) {
  ...
  if (args.rid) {
    /*jshint multistr: true */
    query = 'SELECT COUNT(DISTINCT userId) as aggregate FROM mofointegration.wm_metrics_referrers_and_badges \
                WHERE referrer = ? \
 ...
 * @param  {Function} callback
 */
function queryBadgesRepeat (args, badgeNames, callback) {
  'use strict';
  var startDateInclusive  = aggregateStartDate(args);
  var endDateInclusive    = aggregateEndDate(args);
  ...
  if (args.rid) {
    ...
    // TOTAL - No RID supplied, so look at the total webmaker numbers instead
    /*jshint multistr: true */
    query = 'SELECT null as aggregate;';
    values = [];
  }
 ...
 * @param  {Function} callback
 */
function usersRepeat (args, callback) {
  'use strict';
  var startDateInclusive  = aggregateStartDate(args);
  var endDateInclusive    = aggregateEndDate(args);
...
function learnersNew (args, callback) {
  'use strict';
  callback(null, 1);
}

function learnersRepeat (args, callback) {
  'use strict';
  callback(null, 1);
}
...
function mvcBadgeRepeat (args, callback) {
  'use strict';
  queryBadgesRepeat(args, BADGE_NAMES_MVC, function (err, res) {
    if (err) {
      console.error(err);
      return callback (err);
    }
...
function eventHostsRepeat (args, callback) {
  'use strict';
  callback(null, 1);
}
...
function mentorsRepeat (args, callback) {
  'use strict';
  queryBadgesRepeat(args, BADGE_NAMES_MENTOR, function (err, res) {
    if (err) {
      console.error(err);
      return callback (err);
    }
...
function superMentorsRepeat (args, callback) {
  'use strict';
  queryBadgesRepeat(args, BADGE_NAMES_SUPER_MENTOR, function (err, res) {
    if (err) {
      console.error(err);
      return callback (err);
    }
...
function makersRepeat (args, callback) {
  'use strict';
  callback(null, 1);
}
...
module.exports = {
  ...
  learnersNew: learnersNew,
  learnersRepeat: learnersRepeat,
  mvcBadgeNew: mvcBadgeNew,
  mvcBadgeRepeat: mvcBadgeRepeat,
  eventHostsNew: eventHostsNew,
  eventHostsRepeat: eventHostsRepeat,
  mentorsNew: mentorsNew,
  mentorsRepeat: mentorsRepeat,
  superMentorsNew: superMentorsNew,
  superMentorsRepeat: superMentorsRepeat,
  makersNew: makersNew,
  makersRepeat: makersRepeat,
};
