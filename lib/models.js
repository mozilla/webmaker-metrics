if (!global.hasOwnProperty('db')) {
  ...
  var ProductFunnelSnapshot = sequelize.define('ProductFunnelSnapshot', {
    ...
    RetainedUsers7days: Sequelize.INTEGER,
    RetainedUsers30days: Sequelize.INTEGER,
    RetainedUsers90days: Sequelize.INTEGER
  });
  ...
  var CountryDataSnapshot = sequelize.define('CountryDataSnapshot', {
    snapshotDate: {type: Sequelize.DATE, unique: 'idxDateCountry'},
    country: {type: Sequelize.STRING, unique: 'idxDateCountry'},
    UVs30days: Sequelize.INTEGER,
    UVsToInternetUsers: Sequelize.DECIMAL(6,5),
    InternetUsers: Sequelize.INTEGER
  });

  var RelationshipsSnapshot = sequelize.define('RelationshipsSnapshot', {
    snapshotDate: {type: Sequelize.DATE, unique: true},
    people: Sequelize.INTEGER
  });
  ...
  global.db = {
    ...
    CountryDataSnapshot: CountryDataSnapshot,
